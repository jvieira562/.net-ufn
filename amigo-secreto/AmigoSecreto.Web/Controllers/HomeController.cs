...
namespace AmigoSecreto.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            homeModel.Amigos = await _api.ObterAmigosAsync();
        ...
        {
            var model = new ParticipantesViewModel();
            model.Participantes = await _api.ObterAmigosAsync();

            return View("Participantes", model);
        }
        [Authorize]
